...
class InforAgent(object):
    ...
    def __init__(self, unique_id: int, model, u_yes=0.5, u_no = 0.5, risk_coeff=0, available=1, vote_day =0, states={}, beta_a=3, beta_b=3, belief_reliable_up=1, belief_reliable_down=0, vote_choice=1) -> None:
